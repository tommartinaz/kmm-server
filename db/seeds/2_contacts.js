  ...
  return knex('contacts').del()
    .then(function () {
      ...
      return knex('contacts').insert([
        ...
        {id: uuidv4(), name: 'Julie Smith', company: 'ABC', website: 'www.abc.com', email: 'julie.smith@abc.com.com', phone: '602-111-9988', client_status: 'Existing Client', message: 'Love your site. Need video. Please contact, Julie', followUp_date: moment('08/15/2018', 'MM/DD/YYYY'), followUp_status: 'Mtg. Scheduled', promo_offerred: 'No', promo_discount: '10%', promo_expires: '09/15/2018', promo_status: 'Pending'},
